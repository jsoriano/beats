...
These are the available fields during within config templating. The `meta.*` fields will be available
...
* meta.status
* meta.task.name
* meta.task.service.name
* meta.task.service.tags
* meta.task.service.canary_tags
...
-------------------------------------------------------------------------------------
{
  ...
  "region": "europe",
  "type": "service",
  "alloc_id": "35eba07f-e5e4-20ac-6def-85117bee6efb",
  "datacenters": [
    "europe-west4"
  ],
  "namespace": "default",
