...
*`prometheus.metrics.addsstable_applications`*::
+
--
...
*`prometheus.metrics.addsstable_copies`*::
+
--
...
*`prometheus.metrics.addsstable_proposals`*::
+
--
...
*`prometheus.metrics.build_timestamp`*::
+
--
Build information
...
*`prometheus.metrics.capacity_available`*::
+
--
...
*`prometheus.metrics.capacity_reserved`*::
+
--
...
*`prometheus.metrics.capacity_used`*::
+
--
...
*`prometheus.metrics.changefeed_buffer_entries_in`*::
+
--
Total entries entering the buffer between raft and changefeed sinks
...
*`prometheus.metrics.changefeed_buffer_entries_out`*::
+
--
Total entries leaving the buffer between raft and changefeed sinks
...
*`prometheus.metrics.changefeed_emit_nanos`*::
+
--
Total time spent emitting all feeds
...
*`prometheus.metrics.changefeed_emitted_bytes`*::
+
--
...
*`prometheus.metrics.changefeed_emitted_messages`*::
+
--
Messages emitted by all feeds
...
*`prometheus.metrics.changefeed_error_retries`*::
+
--
Total retryable errors encountered by all changefeeds
...
*`prometheus.metrics.changefeed_flush_nanos`*::
+
--
Total time spent flushing all feeds
...
*`prometheus.metrics.changefeed_flushes`*::
+
--
Total flushes across all feeds
...
*`prometheus.metrics.changefeed_max_behind_nanos`*::
+
--
Largest commit-to-emit duration of any running feed
...
*`prometheus.metrics.changefeed_min_high_water`*::
+
--
Latest high-water timestamp of most behind feed
...
*`prometheus.metrics.changefeed_poll_request_nanos_bucket`*::
+
--
Time spent fetching changes
...
*`prometheus.metrics.changefeed_poll_request_nanos_sum`*::
+
--
Sum of Time spent fetching changes
...
*`prometheus.metrics.changefeed_poll_request_nanos_count`*::
+
--
Count of Time spent fetching changes
...
*`prometheus.metrics.changefeed_processing_nanos`*::
+
--
Time spent processing KV changes into SQL rows
...
*`prometheus.metrics.changefeed_table_metadata_nanos`*::
+
--
Time blocked while verifying table metadata histories
...
*`prometheus.metrics.clock_offset_meannanos`*::
+
--
Mean clock offset with other nodes
...
*`prometheus.metrics.clock_offset_stddevnanos`*::
+
--
Stddev clock offset with other nodes
...
*`prometheus.metrics.compactor_compactingnanos`*::
+
--
...
*`prometheus.metrics.compactor_compactions_failure`*::
+
--
...
*`prometheus.metrics.compactor_compactions_success`*::
+
--
...
*`prometheus.metrics.compactor_suggestionbytes_compacted`*::
+
--
...
*`prometheus.metrics.compactor_suggestionbytes_queued`*::
+
--
...
*`prometheus.metrics.compactor_suggestionbytes_skipped`*::
+
--
...
*`prometheus.metrics.distsender_batches`*::
+
--
...
*`prometheus.metrics.distsender_batches_async_sent`*::
+
--
Number of partial batches sent asynchronously
...
*`prometheus.metrics.distsender_batches_async_throttled`*::
+
--
Number of partial batches not sent asynchronously due to throttling
...
*`prometheus.metrics.distsender_batches_partial`*::
+
--
Number of partial batches processed after being divided on range boundaries
...
+
--
Number of times backed off due to NotLeaseHolderErrors during lease transfer.
...
*`prometheus.metrics.distsender_errors_notleaseholder`*::
+
--
...
*`prometheus.metrics.distsender_rpc_sent`*::
+
--
Number of RPCs sent
...
*`prometheus.metrics.distsender_rpc_sent_local`*::
+
--
...
*`prometheus.metrics.distsender_rpc_sent_nextreplicaerror`*::
+
--
...
*`prometheus.metrics.exec_latency_bucket`*::
+
--
Latency of batch KV requests executed on this node
...
*`prometheus.metrics.exec_latency_sum`*::
+
--
Sum of Latency of batch KV requests executed on this node
...
*`prometheus.metrics.exec_latency_count`*::
+
--
Count of Latency of batch KV requests executed on this node
...
*`prometheus.metrics.exec_success`*::
+
--
...
*`prometheus.metrics.follower_reads_success_count`*::
+
--
Number of reads successfully processed by any replica
...
*`prometheus.metrics.gcbytesage`*::
+
--
Cumulative age of non-live data
...
*`prometheus.metrics.gossip_bytes_received`*::
+
--
...
*`prometheus.metrics.gossip_bytes_sent`*::
+
--
...
*`prometheus.metrics.gossip_connections_incoming`*::
+
--
...
*`prometheus.metrics.gossip_connections_outgoing`*::
+
--
...
*`prometheus.metrics.gossip_connections_refused`*::
+
--
...
*`prometheus.metrics.gossip_infos_received`*::
+
--
...
*`prometheus.metrics.gossip_infos_sent`*::
+
--
...
*`prometheus.metrics.intentage`*::
+
--
Cumulative age of intents
...
*`prometheus.metrics.intentbytes`*::
+
--
...
*`prometheus.metrics.intentcount`*::
+
--
...
*`prometheus.metrics.intentresolver_async_throttled`*::
+
--
Number of intent resolution attempts not run asynchronously due to throttling
...
*`prometheus.metrics.intents_abort_attempts`*::
+
--
Count of (point or range) non-poisoning intent abort evaluation attempts
...
*`prometheus.metrics.intents_poison_attempts`*::
+
--
Count of (point or range) poisoning intent abort evaluation attempts
...
*`prometheus.metrics.intents_resolve_attempts`*::
+
--
Count of (point or range) intent commit evaluation attempts
...
*`prometheus.metrics.kv_closed_timestamp_max_behind_nanos`*::
+
--
...
*`prometheus.metrics.kv_rangefeed_catchup_scan_nanos`*::
+
--
Time spent in RangeFeed catchup scan
...
*`prometheus.metrics.lastupdatenanos`*::
+
--
Timestamp at which bytes/keys/intents metrics were last updated
...
*`prometheus.metrics.leases_epoch`*::
+
--
...
*`prometheus.metrics.leases_error`*::
+
--
...
*`prometheus.metrics.leases_expiration`*::
+
--
...
*`prometheus.metrics.leases_success`*::
+
--
...
*`prometheus.metrics.leases_transfers_error`*::
+
--
...
*`prometheus.metrics.leases_transfers_success`*::
+
--
...
*`prometheus.metrics.liveness_epochincrements`*::
+
--
...
*`prometheus.metrics.liveness_heartbeatfailures`*::
+
--
...
*`prometheus.metrics.liveness_heartbeatlatency_bucket`*::
+
--
Node liveness heartbeat latency
...
*`prometheus.metrics.liveness_heartbeatlatency_sum`*::
+
--
Sum of Node liveness heartbeat latency
...
*`prometheus.metrics.liveness_heartbeatlatency_count`*::
+
--
Count of Node liveness heartbeat latency
...
*`prometheus.metrics.liveness_heartbeatsuccesses`*::
+
--
...
*`prometheus.metrics.liveness_livenodes`*::
+
--
...
*`prometheus.metrics.queue_consistency_pending`*::
+
--
...
*`prometheus.metrics.queue_consistency_process_failure`*::
+
--
...
*`prometheus.metrics.queue_consistency_process_success`*::
+
--
...
*`prometheus.metrics.queue_consistency_processingnanos`*::
+
--
...
*`prometheus.metrics.queue_gc_info_abortspanconsidered`*::
+
--
...
*`prometheus.metrics.queue_gc_info_abortspangcnum`*::
+
--
...
*`prometheus.metrics.queue_gc_info_abortspanscanned`*::
+
--
...
*`prometheus.metrics.queue_gc_info_intentsconsidered`*::
+
--
...
*`prometheus.metrics.queue_gc_info_intenttxns`*::
+
--
...
*`prometheus.metrics.queue_gc_info_numkeysaffected`*::
+
--
...
*`prometheus.metrics.queue_gc_info_pushtxn`*::
+
--
...
*`prometheus.metrics.queue_gc_info_resolvesuccess`*::
+
--
...
*`prometheus.metrics.queue_gc_info_resolvetotal`*::
+
--
...
*`prometheus.metrics.queue_gc_info_transactionspangcaborted`*::
+
--
...
*`prometheus.metrics.queue_gc_info_transactionspangccommitted`*::
+
--
...
*`prometheus.metrics.queue_gc_info_transactionspangcpending`*::
+
--
...
*`prometheus.metrics.queue_gc_info_transactionspanscanned`*::
+
--
...
*`prometheus.metrics.queue_gc_pending`*::
+
--
...
*`prometheus.metrics.queue_gc_process_failure`*::
+
--
...
*`prometheus.metrics.queue_gc_process_success`*::
+
--
...
*`prometheus.metrics.queue_gc_processingnanos`*::
+
--
...
*`prometheus.metrics.queue_merge_pending`*::
+
--
Number of pending replicas in the merge queue
...
*`prometheus.metrics.queue_merge_process_failure`*::
+
--
Number of replicas which failed processing in the merge queue
...
*`prometheus.metrics.queue_merge_process_success`*::
+
--
Number of replicas successfully processed by the merge queue
...
*`prometheus.metrics.queue_merge_processingnanos`*::
+
--
Nanoseconds spent processing replicas in the merge queue
...
*`prometheus.metrics.queue_merge_purgatory`*::
+
--
Number of replicas in the merge queue's purgatory, waiting to become mergeable
...
*`prometheus.metrics.queue_raftlog_pending`*::
+
--
...
*`prometheus.metrics.queue_raftlog_process_failure`*::
+
--
...
*`prometheus.metrics.queue_raftlog_process_success`*::
+
--
...
*`prometheus.metrics.queue_raftlog_processingnanos`*::
+
--
...
*`prometheus.metrics.queue_raftsnapshot_pending`*::
+
--
...
*`prometheus.metrics.queue_raftsnapshot_process_failure`*::
+
--
...
*`prometheus.metrics.queue_raftsnapshot_process_success`*::
+
--
...
*`prometheus.metrics.queue_raftsnapshot_processingnanos`*::
+
--
...
*`prometheus.metrics.queue_replicagc_pending`*::
+
--
...
*`prometheus.metrics.queue_replicagc_process_failure`*::
+
--
...
*`prometheus.metrics.queue_replicagc_process_success`*::
+
--
...
*`prometheus.metrics.queue_replicagc_processingnanos`*::
+
--
...
*`prometheus.metrics.queue_replicagc_removereplica`*::
+
--
...
*`prometheus.metrics.queue_replicate_addreplica`*::
+
--
...
*`prometheus.metrics.queue_replicate_pending`*::
+
--
...
*`prometheus.metrics.queue_replicate_process_failure`*::
+
--
...
*`prometheus.metrics.queue_replicate_process_success`*::
+
--
...
*`prometheus.metrics.queue_replicate_processingnanos`*::
+
--
...
*`prometheus.metrics.queue_replicate_purgatory`*::
+
--
...
*`prometheus.metrics.queue_replicate_rebalancereplica`*::
+
--
...
*`prometheus.metrics.queue_replicate_removedeadreplica`*::
+
--
...
*`prometheus.metrics.queue_replicate_removereplica`*::
+
--
...
*`prometheus.metrics.queue_replicate_transferlease`*::
+
--
...
*`prometheus.metrics.queue_split_pending`*::
+
--
...
*`prometheus.metrics.queue_split_process_failure`*::
+
--
...
*`prometheus.metrics.queue_split_process_success`*::
+
--
...
*`prometheus.metrics.queue_split_processingnanos`*::
+
--
...
*`prometheus.metrics.queue_split_purgatory`*::
+
--
Number of replicas in the split queue's purgatory, waiting to become splittable
...
*`prometheus.metrics.queue_tsmaintenance_pending`*::
+
--
...
*`prometheus.metrics.queue_tsmaintenance_process_failure`*::
+
--
...
*`prometheus.metrics.queue_tsmaintenance_process_success`*::
+
--
...
*`prometheus.metrics.queue_tsmaintenance_processingnanos`*::
+
--
...
*`prometheus.metrics.raft_commandsapplied`*::
+
--
...
*`prometheus.metrics.raft_enqueued_pending`*::
+
--
...
*`prometheus.metrics.raft_entrycache_accesses`*::
+
--
Number of cache lookups in the Raft entry cache
...
*`prometheus.metrics.raft_entrycache_bytes`*::
+
--
Aggregate size of all Raft entries in the Raft entry cache
...
*`prometheus.metrics.raft_entrycache_hits`*::
+
--
Number of successful cache lookups in the Raft entry cache
...
*`prometheus.metrics.raft_entrycache_size`*::
+
--
Number of Raft entries in the Raft entry cache
...
*`prometheus.metrics.raft_heartbeats_pending`*::
+
--
...
*`prometheus.metrics.raft_process_applycommitted_latency_bucket`*::
+
--
Latency histogram for applying all committed Raft commands in a Raft ready
...
*`prometheus.metrics.raft_process_applycommitted_latency_sum`*::
+
--
Sum of Latency histogram for applying all committed Raft commands in a Raft ready
...
*`prometheus.metrics.raft_process_applycommitted_latency_count`*::
+
--
Count of Latency histogram for applying all committed Raft commands in a Raft ready
...
*`prometheus.metrics.raft_process_commandcommit_latency_bucket`*::
+
--
Latency histogram for committing Raft commands
...
*`prometheus.metrics.raft_process_commandcommit_latency_sum`*::
+
--
Sum of Latency histogram for committing Raft commands
...
*`prometheus.metrics.raft_process_commandcommit_latency_count`*::
+
--
Count of Latency histogram for committing Raft commands
...
*`prometheus.metrics.raft_process_handleready_latency_bucket`*::
+
--
...
*`prometheus.metrics.raft_process_handleready_latency_sum`*::
+
--
Sum of Latency histogram for handling a Raft ready
...
*`prometheus.metrics.raft_process_handleready_latency_count`*::
+
--
Count of Latency histogram for handling a Raft ready
...
*`prometheus.metrics.raft_process_logcommit_latency_bucket`*::
+
--
Latency histogram for committing Raft log entries
...
*`prometheus.metrics.raft_process_logcommit_latency_sum`*::
+
--
Sum of Latency histogram for committing Raft log entries
...
*`prometheus.metrics.raft_process_logcommit_latency_count`*::
+
--
Count of Latency histogram for committing Raft log entries
...
*`prometheus.metrics.raft_process_tickingnanos`*::
+
--
...
*`prometheus.metrics.raft_process_workingnanos`*::
+
--
...
*`prometheus.metrics.raft_rcvd_app`*::
+
--
...
*`prometheus.metrics.raft_rcvd_appresp`*::
+
--
...
*`prometheus.metrics.raft_rcvd_dropped`*::
+
--
...
*`prometheus.metrics.raft_rcvd_heartbeat`*::
+
--
...
*`prometheus.metrics.raft_rcvd_heartbeatresp`*::
+
--
...
*`prometheus.metrics.raft_rcvd_prevote`*::
+
--
...
*`prometheus.metrics.raft_rcvd_prevoteresp`*::
+
--
...
*`prometheus.metrics.raft_rcvd_prop`*::
+
--
...
*`prometheus.metrics.raft_rcvd_snap`*::
+
--
...
*`prometheus.metrics.raft_rcvd_timeoutnow`*::
+
--
...
*`prometheus.metrics.raft_rcvd_transferleader`*::
+
--
...
*`prometheus.metrics.raft_rcvd_vote`*::
+
--
...
*`prometheus.metrics.raft_rcvd_voteresp`*::
+
--
...
*`prometheus.metrics.raftlog_behind`*::
+
--
...
*`prometheus.metrics.raftlog_truncated`*::
+
--
...
*`prometheus.metrics.range_merges`*::
+
--
...
*`prometheus.metrics.range_raftleadertransfers`*::
+
--
...
*`prometheus.metrics.range_removes`*::
+
--
...
*`prometheus.metrics.range_snapshots_normal_applied`*::
+
--
...
*`prometheus.metrics.range_snapshots_preemptive_applied`*::
+
--
Number of applied pre-emptive snapshots
...
*`prometheus.metrics.range_splits`*::
+
--
...
*`prometheus.metrics.ranges_overreplicated`*::
+
--
...
*`prometheus.metrics.ranges_unavailable`*::
+
--
...
*`prometheus.metrics.ranges_underreplicated`*::
+
--
...
*`prometheus.metrics.rebalancing_lease_transfers`*::
+
--
Number of lease transfers motivated by store-level load imbalances
...
*`prometheus.metrics.rebalancing_queriespersecond`*::
+
--
...
*`prometheus.metrics.rebalancing_range_rebalances`*::
+
--
Number of range rebalance operations motivated by store-level load imbalances
...
*`prometheus.metrics.rebalancing_writespersecond`*::
+
--
...
*`prometheus.metrics.replicas_leaders`*::
+
--
...
*`prometheus.metrics.replicas_leaders_not_leaseholders`*::
+
--
...
*`prometheus.metrics.replicas_leaseholders`*::
+
--
...
*`prometheus.metrics.replicas_quiescent`*::
+
--
...
*`prometheus.metrics.replicas_reserved`*::
+
--
...
*`prometheus.metrics.requests_backpressure_split`*::
+
--
...
*`prometheus.metrics.requests_slow_latch`*::
+
--
...
*`prometheus.metrics.requests_slow_lease`*::
+
--
...
*`prometheus.metrics.requests_slow_raft`*::
+
--
...
*`prometheus.metrics.rocksdb_block_cache_hits`*::
+
--
...
*`prometheus.metrics.rocksdb_block_cache_misses`*::
+
--
...
*`prometheus.metrics.rocksdb_block_cache_pinned_usage`*::
+
--
...
*`prometheus.metrics.rocksdb_block_cache_usage`*::
+
--
...
*`prometheus.metrics.rocksdb_bloom_filter_prefix_checked`*::
+
--
...
*`prometheus.metrics.rocksdb_bloom_filter_prefix_useful`*::
+
--
...
*`prometheus.metrics.rocksdb_compactions`*::
+
--
...
*`prometheus.metrics.rocksdb_encryption_algorithm`*::
+
--
algorithm in use for encryption-at-rest, see ccl/storageccl/engineccl/enginepbccl/key_registry.proto
...
*`prometheus.metrics.rocksdb_flushes`*::
+
--
...
*`prometheus.metrics.rocksdb_memtable_total_size`*::
+
--
...
*`prometheus.metrics.rocksdb_num_sstables`*::
+
--
...
*`prometheus.metrics.rocksdb_read_amplification`*::
+
--
...
*`prometheus.metrics.rocksdb_table_readers_mem_estimate`*::
+
--
...
*`prometheus.metrics.round_trip_latency_sum`*::
+
--
Sum of Distribution of round-trip latencies with other nodes
...
*`prometheus.metrics.round_trip_latency_count`*::
+
--
Count of Distribution of round-trip latencies with other nodes
...
*`prometheus.metrics.sql_bytesin`*::
+
--
...
*`prometheus.metrics.sql_bytesout`*::
+
--
...
*`prometheus.metrics.sql_ddl_count`*::
+
--
...
*`prometheus.metrics.sql_ddl_count_internal`*::
+
--
Number of SQL DDL statements (internal queries)
...
*`prometheus.metrics.sql_delete_count`*::
+
--
...
*`prometheus.metrics.sql_delete_count_internal`*::
+
--
Number of SQL DELETE statements (internal queries)
...
*`prometheus.metrics.sql_distsql_exec_latency_bucket`*::
+
--
Latency of DistSQL statement execution
...
*`prometheus.metrics.sql_distsql_exec_latency_sum`*::
+
--
Sum of Latency of DistSQL statement execution
...
*`prometheus.metrics.sql_distsql_exec_latency_count`*::
+
--
Count of Latency of DistSQL statement execution
...
*`prometheus.metrics.sql_distsql_exec_latency_internal_bucket`*::
+
--
Latency of DistSQL statement execution (internal queries)
...
*`prometheus.metrics.sql_distsql_exec_latency_internal_sum`*::
+
--
Sum of Latency of DistSQL statement execution (internal queries)
...
*`prometheus.metrics.sql_distsql_exec_latency_internal_count`*::
+
--
Count of Latency of DistSQL statement execution (internal queries)
...
*`prometheus.metrics.sql_distsql_flows_active`*::
+
--
...
*`prometheus.metrics.sql_distsql_flows_queue_wait_bucket`*::
+
--
Duration of time flows spend waiting in the queue
...
*`prometheus.metrics.sql_distsql_flows_queue_wait_sum`*::
+
--
Sum of Duration of time flows spend waiting in the queue
...
*`prometheus.metrics.sql_distsql_flows_queue_wait_count`*::
+
--
Count of Duration of time flows spend waiting in the queue
...
*`prometheus.metrics.sql_distsql_flows_queued`*::
+
--
Number of distributed SQL flows currently queued
...
*`prometheus.metrics.sql_distsql_flows_total`*::
+
--
...
*`prometheus.metrics.sql_distsql_queries_active`*::
+
--
...
*`prometheus.metrics.sql_distsql_queries_total`*::
+
--
...
*`prometheus.metrics.sql_distsql_select_count`*::
+
--
...
*`prometheus.metrics.sql_distsql_select_count_internal`*::
+
--
Number of DistSQL SELECT statements (internal queries)
...
*`prometheus.metrics.sql_distsql_service_latency_bucket`*::
+
--
Latency of DistSQL request execution
...
*`prometheus.metrics.sql_distsql_service_latency_sum`*::
+
--
Sum of Latency of DistSQL request execution
...
*`prometheus.metrics.sql_distsql_service_latency_count`*::
+
--
Count of Latency of DistSQL request execution
...
*`prometheus.metrics.sql_distsql_service_latency_internal_bucket`*::
+
--
Latency of DistSQL request execution (internal queries)
...
*`prometheus.metrics.sql_distsql_service_latency_internal_sum`*::
+
--
Sum of Latency of DistSQL request execution (internal queries)
...
*`prometheus.metrics.sql_distsql_service_latency_internal_count`*::
+
--
Count of Latency of DistSQL request execution (internal queries)
...
*`prometheus.metrics.sql_exec_latency_bucket`*::
+
--
Latency of SQL statement execution
...
*`prometheus.metrics.sql_exec_latency_sum`*::
+
--
Sum of Latency of SQL statement execution
...
*`prometheus.metrics.sql_exec_latency_count`*::
+
--
Count of Latency of SQL statement execution
...
*`prometheus.metrics.sql_exec_latency_internal_bucket`*::
+
--
Latency of SQL statement execution (internal queries)
...
*`prometheus.metrics.sql_exec_latency_internal_sum`*::
+
--
Sum of Latency of SQL statement execution (internal queries)
...
*`prometheus.metrics.sql_exec_latency_internal_count`*::
+
--
Count of Latency of SQL statement execution (internal queries)
...
*`prometheus.metrics.sql_failure_count`*::
+
--
...
*`prometheus.metrics.sql_failure_count_internal`*::
+
--
Number of statements resulting in a planning or runtime error (internal queries)
...
*`prometheus.metrics.sql_insert_count`*::
+
--
...
*`prometheus.metrics.sql_insert_count_internal`*::
+
--
Number of SQL INSERT statements (internal queries)
...
*`prometheus.metrics.sql_mem_admin_current`*::
+
--
Current sql statement memory usage for admin
...
*`prometheus.metrics.sql_mem_admin_max_bucket`*::
+
--
Memory usage per sql statement for admin
...
*`prometheus.metrics.sql_mem_admin_max_sum`*::
+
--
Sum of Memory usage per sql statement for admin
...
*`prometheus.metrics.sql_mem_admin_max_count`*::
+
--
Count of Memory usage per sql statement for admin
...
*`prometheus.metrics.sql_mem_admin_session_current`*::
+
--
Current sql session memory usage for admin
...
*`prometheus.metrics.sql_mem_admin_session_max_bucket`*::
+
--
Memory usage per sql session for admin
...
*`prometheus.metrics.sql_mem_admin_session_max_sum`*::
+
--
Sum of Memory usage per sql session for admin
...
*`prometheus.metrics.sql_mem_admin_session_max_count`*::
+
--
Count of Memory usage per sql session for admin
...
*`prometheus.metrics.sql_mem_admin_txn_current`*::
+
--
Current sql transaction memory usage for admin
...
*`prometheus.metrics.sql_mem_admin_txn_max_bucket`*::
+
--
Memory usage per sql transaction for admin
...
*`prometheus.metrics.sql_mem_admin_txn_max_sum`*::
+
--
Sum of Memory usage per sql transaction for admin
...
*`prometheus.metrics.sql_mem_admin_txn_max_count`*::
+
--
Count of Memory usage per sql transaction for admin
...
*`prometheus.metrics.sql_mem_conns_current`*::
+
--
Current sql statement memory usage for conns
...
*`prometheus.metrics.sql_mem_conns_max_bucket`*::
+
--
Memory usage per sql statement for conns
...
*`prometheus.metrics.sql_mem_conns_max_sum`*::
+
--
Sum of Memory usage per sql statement for conns
...
*`prometheus.metrics.sql_mem_conns_max_count`*::
+
--
Count of Memory usage per sql statement for conns
...
*`prometheus.metrics.sql_mem_conns_session_current`*::
+
--
Current sql session memory usage for conns
...
*`prometheus.metrics.sql_mem_conns_session_max_bucket`*::
+
--
Memory usage per sql session for conns
...
*`prometheus.metrics.sql_mem_conns_session_max_sum`*::
+
--
Sum of Memory usage per sql session for conns
...
*`prometheus.metrics.sql_mem_conns_session_max_count`*::
+
--
Count of Memory usage per sql session for conns
...
*`prometheus.metrics.sql_mem_conns_txn_current`*::
+
--
Current sql transaction memory usage for conns
...
*`prometheus.metrics.sql_mem_conns_txn_max_bucket`*::
+
--
Memory usage per sql transaction for conns
...
*`prometheus.metrics.sql_mem_conns_txn_max_sum`*::
+
--
Sum of Memory usage per sql transaction for conns
...
*`prometheus.metrics.sql_mem_conns_txn_max_count`*::
+
--
Count of Memory usage per sql transaction for conns
...
*`prometheus.metrics.sql_mem_distsql_current`*::
+
--
...
*`prometheus.metrics.sql_mem_distsql_max_bucket`*::
+
--
...
*`prometheus.metrics.sql_mem_distsql_max_sum`*::
+
--
Sum of Memory usage per sql statement for distsql
...
*`prometheus.metrics.sql_mem_distsql_max_count`*::
+
--
Count of Memory usage per sql statement for distsql
...
*`prometheus.metrics.sql_mem_internal_current`*::
+
--
Current sql statement memory usage for internal
...
*`prometheus.metrics.sql_mem_internal_max_bucket`*::
+
--
Memory usage per sql statement for internal
...
*`prometheus.metrics.sql_mem_internal_max_sum`*::
+
--
Sum of Memory usage per sql statement for internal
...
*`prometheus.metrics.sql_mem_internal_max_count`*::
+
--
Count of Memory usage per sql statement for internal
...
*`prometheus.metrics.sql_mem_internal_session_current`*::
+
--
...
*`prometheus.metrics.sql_mem_internal_session_max_bucket`*::
+
--
...
*`prometheus.metrics.sql_mem_internal_session_max_sum`*::
+
--
Sum of Memory usage per sql session for internal
...
*`prometheus.metrics.sql_mem_internal_session_max_count`*::
+
--
Count of Memory usage per sql session for internal
...
*`prometheus.metrics.sql_mem_internal_txn_current`*::
+
--
...
*`prometheus.metrics.sql_mem_internal_txn_max_bucket`*::
+
--
...
*`prometheus.metrics.sql_mem_internal_txn_max_sum`*::
+
--
Sum of Memory usage per sql transaction for internal
...
*`prometheus.metrics.sql_mem_internal_txn_max_count`*::
+
--
Count of Memory usage per sql transaction for internal
...
*`prometheus.metrics.sql_mem_sql_current`*::
+
--
Current sql statement memory usage for sql
...
*`prometheus.metrics.sql_mem_sql_max_bucket`*::
+
--
Memory usage per sql statement for sql
...
*`prometheus.metrics.sql_mem_sql_max_sum`*::
+
--
Sum of Memory usage per sql statement for sql
...
*`prometheus.metrics.sql_mem_sql_max_count`*::
+
--
Count of Memory usage per sql statement for sql
...
*`prometheus.metrics.sql_mem_sql_session_current`*::
+
--
Current sql session memory usage for sql
...
*`prometheus.metrics.sql_mem_sql_session_max_bucket`*::
+
--
Memory usage per sql session for sql
...
*`prometheus.metrics.sql_mem_sql_session_max_sum`*::
+
--
Sum of Memory usage per sql session for sql
...
*`prometheus.metrics.sql_mem_sql_session_max_count`*::
+
--
Count of Memory usage per sql session for sql
...
*`prometheus.metrics.sql_mem_sql_txn_current`*::
+
--
Current sql transaction memory usage for sql
...
*`prometheus.metrics.sql_mem_sql_txn_max_bucket`*::
+
--
Memory usage per sql transaction for sql
...
*`prometheus.metrics.sql_mem_sql_txn_max_sum`*::
+
--
Sum of Memory usage per sql transaction for sql
...
*`prometheus.metrics.sql_mem_sql_txn_max_count`*::
+
--
Count of Memory usage per sql transaction for sql
...
*`prometheus.metrics.sql_misc_count`*::
+
--
...
*`prometheus.metrics.sql_misc_count_internal`*::
+
--
Number of other SQL statements (internal queries)
...
*`prometheus.metrics.sql_optimizer_count`*::
+
--
Number of statements which ran with the cost-based optimizer
...
*`prometheus.metrics.sql_optimizer_count_internal`*::
+
--
Number of statements which ran with the cost-based optimizer (internal queries)
...
*`prometheus.metrics.sql_optimizer_fallback_count`*::
+
--
Number of statements which the cost-based optimizer was unable to plan
...
*`prometheus.metrics.sql_optimizer_fallback_count_internal`*::
+
--
Number of statements which the cost-based optimizer was unable to plan (internal queries)
...
*`prometheus.metrics.sql_optimizer_plan_cache_hits`*::
+
--
Number of non-prepared statements for which a cached plan was used
...
*`prometheus.metrics.sql_optimizer_plan_cache_hits_internal`*::
+
--
Number of non-prepared statements for which a cached plan was used (internal queries)
...
*`prometheus.metrics.sql_optimizer_plan_cache_misses`*::
+
--
Number of non-prepared statements for which a cached plan was not used
...
*`prometheus.metrics.sql_optimizer_plan_cache_misses_internal`*::
+
--
Number of non-prepared statements for which a cached plan was not used (internal queries)
...
*`prometheus.metrics.sql_query_count`*::
+
--
...
*`prometheus.metrics.sql_query_count_internal`*::
+
--
Number of SQL queries (internal queries)
...
*`prometheus.metrics.sql_restart_savepoint_count`*::
+
--
Number of `SAVEPOINT cockroach_restart` statements
...
*`prometheus.metrics.sql_restart_savepoint_count_internal`*::
+
--
Number of `SAVEPOINT cockroach_restart` statements (internal queries)
...
*`prometheus.metrics.sql_restart_savepoint_release_count`*::
+
--
Number of `RELEASE SAVEPOINT cockroach_restart` statements
...
*`prometheus.metrics.sql_restart_savepoint_release_count_internal`*::
+
--
Number of `RELEASE SAVEPOINT cockroach_restart` statements (internal queries)
...
*`prometheus.metrics.sql_restart_savepoint_rollback_count`*::
+
--
Number of `ROLLBACK TO SAVEPOINT cockroach_restart` statements
...
*`prometheus.metrics.sql_restart_savepoint_rollback_count_internal`*::
+
--
Number of `ROLLBACK TO SAVEPOINT cockroach_restart` statements (internal queries)
...
*`prometheus.metrics.sql_savepoint_count`*::
+
--
Number of SQL SAVEPOINT statements
...
*`prometheus.metrics.sql_savepoint_count_internal`*::
+
--
Number of SQL SAVEPOINT statements (internal queries)
...
*`prometheus.metrics.sql_select_count`*::
+
--
...
*`prometheus.metrics.sql_select_count_internal`*::
+
--
Number of SQL SELECT statements (internal queries)
...
*`prometheus.metrics.sql_service_latency_bucket`*::
+
--
...
*`prometheus.metrics.sql_service_latency_sum`*::
+
--
Sum of Latency of SQL request execution
...
*`prometheus.metrics.sql_service_latency_count`*::
+
--
Count of Latency of SQL request execution
...
*`prometheus.metrics.sql_service_latency_internal_bucket`*::
+
--
Latency of SQL request execution (internal queries)
...
*`prometheus.metrics.sql_service_latency_internal_sum`*::
+
--
Sum of Latency of SQL request execution (internal queries)
...
*`prometheus.metrics.sql_service_latency_internal_count`*::
+
--
Count of Latency of SQL request execution (internal queries)
...
*`prometheus.metrics.sql_txn_abort_count`*::
+
--
...
*`prometheus.metrics.sql_txn_abort_count_internal`*::
+
--
Number of SQL transaction abort errors (internal queries)
...
*`prometheus.metrics.sql_txn_begin_count`*::
+
--
...
*`prometheus.metrics.sql_txn_begin_count_internal`*::
+
--
Number of SQL transaction BEGIN statements (internal queries)
...
*`prometheus.metrics.sql_txn_commit_count`*::
+
--
...
*`prometheus.metrics.sql_txn_commit_count_internal`*::
+
--
Number of SQL transaction COMMIT statements (internal queries)
...
*`prometheus.metrics.sql_txn_rollback_count`*::
+
--
...
*`prometheus.metrics.sql_txn_rollback_count_internal`*::
+
--
Number of SQL transaction ROLLBACK statements (internal queries)
...
*`prometheus.metrics.sql_update_count`*::
+
--
...
*`prometheus.metrics.sql_update_count_internal`*::
+
--
Number of SQL UPDATE statements (internal queries)
...
*`prometheus.metrics.sys_cgo_allocbytes`*::
+
--
...
*`prometheus.metrics.sys_cgo_totalbytes`*::
+
--
...
*`prometheus.metrics.sys_cgocalls`*::
+
--
...
*`prometheus.metrics.sys_cpu_combined_percent_normalized`*::
+
--
...
*`prometheus.metrics.sys_cpu_sys_ns`*::
+
--
...
*`prometheus.metrics.sys_cpu_sys_percent`*::
+
--
...
*`prometheus.metrics.sys_cpu_user_ns`*::
+
--
Total user cpu time
...
*`prometheus.metrics.sys_cpu_user_percent`*::
+
--
...
*`prometheus.metrics.sys_fd_open`*::
+
--
...
*`prometheus.metrics.sys_fd_softlimit`*::
+
--
...
*`prometheus.metrics.sys_gc_count`*::
+
--
...
*`prometheus.metrics.sys_gc_pause_ns`*::
+
--
Total GC pause
...
*`prometheus.metrics.sys_gc_pause_percent`*::
+
--
...
*`prometheus.metrics.sys_go_allocbytes`*::
+
--
...
*`prometheus.metrics.sys_go_totalbytes`*::
+
--
...
*`prometheus.metrics.sys_goroutines`*::
+
--
...
*`prometheus.metrics.sys_host_disk_io_time`*::
+
--
Time spent reading from or writing to all disks since this process started
...
*`prometheus.metrics.sys_host_disk_iopsinprogress`*::
+
--
...
*`prometheus.metrics.sys_host_disk_read_bytes`*::
+
--
Bytes read from all disks since this process started
...
*`prometheus.metrics.sys_host_disk_read_count`*::
+
--
...
*`prometheus.metrics.sys_host_disk_read_time`*::
+
--
Time spent reading from all disks since this process started
...
*`prometheus.metrics.sys_host_disk_weightedio_time`*::
+
--
Weighted time spent reading from or writing to to all disks since this process started
...
*`prometheus.metrics.sys_host_disk_write_bytes`*::
+
--
Bytes written to all disks since this process started
...
*`prometheus.metrics.sys_host_disk_write_count`*::
+
--
...
*`prometheus.metrics.sys_host_disk_write_time`*::
+
--
Time spent writing to all disks since this process started
...
*`prometheus.metrics.sys_host_net_recv_bytes`*::
+
--
...
*`prometheus.metrics.sys_host_net_recv_packets`*::
+
--
Packets received on all network interfaces since this process started
...
*`prometheus.metrics.sys_host_net_send_bytes`*::
+
--
...
*`prometheus.metrics.sys_host_net_send_packets`*::
+
--
Packets sent on all network interfaces since this process started
...
*`prometheus.metrics.timeseries_write_bytes`*::
+
--
...
*`prometheus.metrics.timeseries_write_errors`*::
+
--
...
*`prometheus.metrics.timeseries_write_samples`*::
+
--
...
*`prometheus.metrics.tscache_skl_read_pages`*::
+
--
...
*`prometheus.metrics.tscache_skl_read_rotations`*::
+
--
...
*`prometheus.metrics.tscache_skl_write_pages`*::
+
--
...
*`prometheus.metrics.tscache_skl_write_rotations`*::
+
--
...
*`prometheus.metrics.txn_autoretries`*::
+
--
...
*`prometheus.metrics.txn_commits`*::
+
--
...
*`prometheus.metrics.txn_commits1PC`*::
+
--
...
*`prometheus.metrics.txn_durations_bucket`*::
+
--
KV transaction durations
...
*`prometheus.metrics.txn_durations_sum`*::
+
--
Sum of KV transaction durations
...
*`prometheus.metrics.txn_durations_count`*::
+
--
Count of KV transaction durations
...
*`prometheus.metrics.txn_restarts_bucket`*::
+
--
...
*`prometheus.metrics.txn_restarts_sum`*::
+
--
Sum of Number of restarted KV transactions
...
*`prometheus.metrics.txn_restarts_count`*::
+
--
Count of Number of restarted KV transactions
...
*`prometheus.metrics.txn_restarts_asyncwritefailure`*::
+
--
...
*`prometheus.metrics.txn_restarts_possiblereplay`*::
+
--
...
*`prometheus.metrics.txn_restarts_readwithinuncertainty`*::
+
--
...
*`prometheus.metrics.txn_restarts_serializable`*::
+
--
...
*`prometheus.metrics.txn_restarts_txnaborted`*::
+
--
...
*`prometheus.metrics.txn_restarts_txnpush`*::
+
--
...
*`prometheus.metrics.txn_restarts_unknown`*::
+
--
...
*`prometheus.metrics.txn_restarts_writetooold`*::
+
--
...
*`prometheus.metrics.txn_restarts_writetoooldmulti`*::
+
--
...
*`prometheus.metrics.txnwaitqueue_deadlocks_total`*::
+
--
...
*`prometheus.metrics.txnwaitqueue_pushee_waiting`*::
+
--
Number of pushees on the txn wait queue
...
*`prometheus.metrics.txnwaitqueue_pusher_slow`*::
+
--
The total number of cases where a pusher waited more than the excessive wait threshold
...
*`prometheus.metrics.txnwaitqueue_pusher_wait_time_bucket`*::
+
--
Histogram of durations spent in queue by pushers
...
*`prometheus.metrics.txnwaitqueue_pusher_wait_time_sum`*::
+
--
Sum of Histogram of durations spent in queue by pushers
...
*`prometheus.metrics.txnwaitqueue_pusher_wait_time_count`*::
+
--
Count of Histogram of durations spent in queue by pushers
...
*`prometheus.metrics.txnwaitqueue_pusher_waiting`*::
+
--
Number of pushers on the txn wait queue
...
*`prometheus.metrics.txnwaitqueue_query_wait_time_bucket`*::
+
--
Histogram of durations spent in queue by queries
...
*`prometheus.metrics.txnwaitqueue_query_wait_time_sum`*::
+
--
Sum of Histogram of durations spent in queue by queries
...
*`prometheus.metrics.txnwaitqueue_query_wait_time_count`*::
+
--
Count of Histogram of durations spent in queue by queries
...
*`prometheus.metrics.txnwaitqueue_query_waiting`*::
+
--
Number of transaction status queries waiting for an updated transaction record
